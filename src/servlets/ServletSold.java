...
public class ServletSold extends HttpServlet {

	/** This servlet specifically handles the functionality for marking a vehicle as sold in the database.
	...
	/**
	 * Method is used to retrieve the necessary information to mark a vehicle as sold,
	...
	/**
	 * This doPost method parses the vehicle id into the sold method in the DAO to execute the mark as sold query.
	 * @author Jacob Edwards
	 * @throws ServletException an exception a servlet will commonly throw when it encounters a problem
	 * @throws IOException throws up an error message if there is a problem with an input or output
	 * @param HttpServletRequest provides request information for HTTP servlets.
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			boolean done = dao.soldVehicle(vehicle_id);
